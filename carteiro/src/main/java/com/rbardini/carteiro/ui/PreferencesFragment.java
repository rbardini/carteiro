...
public class PreferencesFragment extends PreferenceFragment implements OnSharedPreferenceChangeListener {
  ...
  public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
    if (key.equals(getString(R.string.pref_key_auto_sync))) {
      if (sharedPreferences.getBoolean(key, true)) {
        ...
        SyncService.unscheduleSync(activity);
      }
    ...
    if (backupManagerAvailable) {
      BackupManagerWrapper.dataChanged(app.getPackageName());
    }
  }
  ...
  private void setNotificationSoundPreference() {
    ...
    Uri uri = Uri.parse(PreferenceManager.getDefaultSharedPreferences(activity).getString(preference.getKey(), ""));
  ...
  private void setNotificationSoundPreference(RingtonePreference preference, Uri uri) {
    ...
    if (ringtone != null) ringtoneTitle = ringtone.getTitle(activity);
