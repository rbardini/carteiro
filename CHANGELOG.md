...
# 3.1.1
- Correção de bugs durante a sincronização

# 3.1.0
- Transições entre telas seguindo as diretrizes do Material Design
- Cabeçalho colapsável na tela de histórico do objeto
- Atalho de aplicativo para adicionar objeto no Android 7.1+ (Nougat)
- Melhorias na indicação de objetos atualizados
...
- Suporte a permissões individuais e backup automático de dados no Android 6.0+ (Marshmallow)
